/*********************************
 Name:           xdateService.js
 By:             stkkj
 Version:        1.0                 Date: 08-08-2013

 Description:
 copy pase implementation of xdate as a service,

 Version:  Date:        Comment:
 1.0       08-00-2013   Initial version (stkkj)
 2.0       18-08-2013   Patched to toString function and parser use format also dd-MM-yyy HH:mm:ss

 *********************************/

angular.module('ArlaModule')
...
//   Should do this for 1.0
            ...
            proto.toString = function (formatString, settings, uniqueness) {
                if (formatString === undefined || !valid(this)) {
                    return format(this, "dd-MM-yyyy HH:mm:ss", undefined, undefined, getUTCMode(this));
...
//COSTUMISATIONS ARE below
        ...
        function parseMDY(str) {
            ...
            var args = [
                parseInt(date[2], 10),  // year
                parseInt(date[1], 10)-1,  // month
                parseInt(date[0], 10)  // date
            ];
            ...
            return XDate.apply(this, args );
        }

        XDate.parsers.push(parseMDY);


        var xdateProvider = XDate

        return xdateProvider;
    }
});
